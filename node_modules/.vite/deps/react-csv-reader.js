...
var require_react_csv_reader = __commonJS({
  "node_modules/react-csv-reader/dist/react-csv-reader.js"(exports, module) {
    module.exports = function(e) {
      ...
      const i = r(1), n = r(2), s = r(3), a = i.forwardRef(({ accept: e2 = ".csv, text/csv", cssClass: t2 = "csv-reader-input", cssInputClass: r2 = "csv-input", cssLabelClass: n2 = "csv-label", fileEncoding: a2 = "UTF-8", inputId: o = "react-csv-reader-input", inputName: u = "react-csv-reader-input", inputStyle: h = {}, label: f, onError: l = () => {
      }, onFileLoaded: d, parserOptions: c = {}, disabled: p = false, strict: g = false }, m) => i.createElement("div", { className: t2 }, f && i.createElement("label", { className: n2, htmlFor: o }, f), i.createElement("input", { className: r2, type: "file", id: o, name: u, style: h, accept: e2, onChange: (t3) => {
        let r3 = new FileReader();
        const i2 = t3.target.files;
        if (i2.length > 0) {
          const t4 = { name: i2[0].name, size: i2[0].size, type: i2[0].type };
          if (g && e2.indexOf(t4.type) <= 0) return void l(new Error(`[strict mode] Accept type not respected: got '${t4.type}' but not in '${e2}'`));
          r3.onload = (e3) => {
            var n3;
            const o2 = s.parse(r3.result, Object.assign(c, { error: l, encoding: a2 }));
            d(null !== (n3 = null == o2 ? void 0 : o2.data) && void 0 !== n3 ? n3 : [], t4, i2[0]);
      ...
      var i, n, s;
      n = [], void 0 === (s = "function" == typeof (i = function e2() {
        "use strict";
        var t2 = "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== t2 ? t2 : {}, r2 = !t2.document && !!t2.postMessage, i2 = r2 && /blob:/i.test((t2.location || {}).protocol), n2 = {}, s2 = 0, a = { parse: function(r3, i3) {
          ...
          var c2 = null;
          return a.NODE_STREAM_INPUT, "string" == typeof r3 ? c2 = i3.download ? new h(i3) : new l(i3) : true === r3.readable && k(r3.read) && k(r3.on) ? c2 = new d(i3) : (t2.File && r3 instanceof File || r3 instanceof Object) && (c2 = new f(i3)), c2.stream(r3);
        }, unparse: function(e3, t3) {
          var r3 = false, i3 = true, n3 = ",", s3 = "\r\n", o2 = '"', u2 = o2 + o2, h2 = false, f2 = null, l2 = false;
          !function() {
            if ("object" == typeof t3) {
              if ("string" != typeof t3.delimiter || a.BAD_DELIMITERS.filter(function(e4) {
                return -1 !== t3.delimiter.indexOf(e4);
              }).length || (n3 = t3.delimiter), ("boolean" == typeof t3.quotes || "function" == typeof t3.quotes || Array.isArray(t3.quotes)) && (r3 = t3.quotes), "boolean" != typeof t3.skipEmptyLines && "string" != typeof t3.skipEmptyLines || (h2 = t3.skipEmptyLines), "string" == typeof t3.newline && (s3 = t3.newline), "string" == typeof t3.quoteChar && (o2 = t3.quoteChar), "boolean" == typeof t3.header && (i3 = t3.header), Array.isArray(t3.columns)) {
                if (0 === t3.columns.length) throw new Error("Option columns is empty");
                f2 = t3.columns;
              }
              void 0 !== t3.escapeChar && (u2 = t3.escapeChar + o2), "boolean" == typeof t3.escapeFormulae && (l2 = t3.escapeFormulae);
            }
          }();
          var d2 = new RegExp(p(o2), "g");
          if ("string" == typeof e3 && (e3 = JSON.parse(e3)), Array.isArray(e3)) {
            if (!e3.length || Array.isArray(e3[0])) return g2(null, e3, h2);
            if ("object" == typeof e3[0]) return g2(f2 || c2(e3[0]), e3, h2);
          } else if ("object" == typeof e3) return "string" == typeof e3.data && (e3.data = JSON.parse(e3.data)), Array.isArray(e3.data) && (e3.fields || (e3.fields = e3.meta && e3.meta.fields), e3.fields || (e3.fields = Array.isArray(e3.data[0]) ? e3.fields : c2(e3.data[0])), Array.isArray(e3.data[0]) || "object" == typeof e3.data[0] || (e3.data = [e3.data])), g2(e3.fields || [], e3.data || [], h2);
          throw new Error("Unable to serialize unrecognized input");
          function c2(e4) {
            if ("object" != typeof e4) return [];
            var t4 = [];
            for (var r4 in e4) t4.push(r4);
            return t4;
          }
          function g2(e4, t4, r4) {
            var a2 = "";
            "string" == typeof e4 && (e4 = JSON.parse(e4)), "string" == typeof t4 && (t4 = JSON.parse(t4));
            var o3 = Array.isArray(e4) && 0 < e4.length, u3 = !Array.isArray(t4[0]);
            if (o3 && i3) {
              for (var h3 = 0; h3 < e4.length; h3++) 0 < h3 && (a2 += n3), a2 += m2(e4[h3], h3);
              0 < t4.length && (a2 += s3);
            }
            for (var f3 = 0; f3 < t4.length; f3++) {
              var l3 = o3 ? e4.length : t4[f3].length, d3 = false, c3 = o3 ? 0 === Object.keys(t4[f3]).length : 0 === t4[f3].length;
              if (r4 && !o3 && (d3 = "greedy" === r4 ? "" === t4[f3].join("").trim() : 1 === t4[f3].length && 0 === t4[f3][0].length), "greedy" === r4 && o3) {
          ...
          function m2(e4, t4) {
            ...
            true === l2 && "string" == typeof e4 && null !== e4.match(/^[=+\-@].*$/) && (e4 = "'" + e4);
            var i4 = e4.toString().replace(d2, u2);
            return "boolean" == typeof r3 && r3 || "function" == typeof r3 && r3(e4, t4) || Array.isArray(r3) && r3[t4] || function(e5, t5) {
              for (var r4 = 0; r4 < t5.length; r4++) if (-1 < e5.indexOf(t5[r4])) return true;
              return false;
        ...
        if (a.RECORD_SEP = String.fromCharCode(30), a.UNIT_SEP = String.fromCharCode(31), a.BYTE_ORDER_MARK = "\uFEFF", a.BAD_DELIMITERS = ["\r", "\n", '"', a.BYTE_ORDER_MARK], a.WORKERS_SUPPORTED = !r2 && !!t2.Worker, a.NODE_STREAM_INPUT = 1, a.LocalChunkSize = 10485760, a.RemoteChunkSize = 5242880, a.DefaultDelimiter = ",", a.Parser = g, a.ParserHandle = c, a.NetworkStreamer = h, a.FileStreamer = f, a.StringStreamer = l, a.ReadableStreamStreamer = d, t2.jQuery) {
          ...
          o.fn.parse = function(e3) {
            ...
            return this.each(function(e4) {
              if ("INPUT" !== o(this).prop("tagName").toUpperCase() || "file" !== o(this).attr("type").toLowerCase() || !t2.FileReader || !this.files || 0 === this.files.length) return true;
              for (var n4 = 0; n4 < this.files.length; n4++) i3.push({ file: this.files[n4], inputElem: this, instanceConfig: o.extend({}, r3) });
            }), n3(), this;
            function n3() {
              if (0 !== i3.length) {
                ...
                if (k(e3.before)) {
                  ...
                  if ("object" == typeof h2) {
                    if ("abort" === h2.action) return t3 = u2.file, r4 = u2.inputElem, n4 = h2.reason, void (k(e3.error) && e3.error({ name: "AbortError" }, t3, r4, n4));
                    if ("skip" === h2.action) return void s3();
                    "object" == typeof h2.config && (u2.instanceConfig = o.extend(u2.instanceConfig, h2.config));
                  } else if ("skip" === h2) return void s3();
                }
              ...
              } else k(e3.complete) && e3.complete();
            }
            function s3() {
              i3.splice(0, 1), n3();
            }
        ...
        function u(e3) {
          this._handle = null, this._finished = false, this._completed = false, this._halted = false, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = true, this._completeResults = { data: [], errors: [], meta: {} }, (function(e4) {
            ...
            if (!this._handle.paused() && !this._handle.aborted()) {
              ...
              if (i2) t2.postMessage({ results: o2, workerId: a.WORKER_ID, finished: h2 });
          ...
          (e3 = e3 || {}).chunkSize || (e3.chunkSize = a.RemoteChunkSize), u.call(this, e3), this._nextChunk = r2 ? function() {
            ...
            if (this._finished) this._chunkLoaded();
              ...
              if (t3 = new XMLHttpRequest(), this._config.withCredentials && (t3.withCredentials = this._config.withCredentials), r2 || (t3.onload = b(this._chunkLoaded, this), t3.onerror = b(this._chunkError, this)), t3.open(this._config.downloadRequestBody ? "POST" : "GET", this._input, !r2), this._config.downloadRequestHeaders) {
                ...
                for (var i3 in e4) t3.setRequestHeader(i3, e4[i3]);
              }
              ...
              r2 && 0 === t3.status && this._chunkError();
            }
          }, this._chunkLoaded = function() {
            4 === t3.readyState && (t3.status < 200 || 400 <= t3.status ? this._chunkError() : (this._start += this._config.chunkSize ? this._config.chunkSize : t3.responseText.length, this._finished = !this._config.chunkSize || this._start >= function(e4) {
              var t4 = e4.getResponseHeader("Content-Range");
              return null === t4 ? -1 : parseInt(t4.substring(t4.lastIndexOf("/") + 1));
        ...
        function f(e3) {
          ...
          var i3 = "undefined" != typeof FileReader;
          this.stream = function(e4) {
        ...
        function d(e3) {
          ...
          this.pause = function() {
            ...
            i3 && 1 === t3.length && (this._finished = true);
          }, this._nextChunk = function() {
            this._checkIsFinished(), t3.length ? this.parseChunk(t3.shift()) : r3 = true;
          }, this._streamData = b(function(e4) {
            try {
              t3.push("string" == typeof e4 ? e4 : e4.toString(this._config.encoding)), r3 && (r3 = false, this._checkIsFinished(), this.parseChunk(t3.shift()));
            } catch (e5) {
        ...
        function c(e3) {
          ...
          if (k(e3.step)) {
            ...
            e3.step = function(t4) {
              if (_2 = t4, w()) E();
                ...
                if (E(), 0 === _2.data.length) return;
                f2 += t4.data.length, e3.preview && f2 > e3.preview ? r3.abort() : (_2.data = _2.data[0], y2(_2, h2));
              }
            };
          }
          function b2(t4) {
            return "greedy" === e3.skipEmptyLines ? "" === t4.join("").trim() : 1 === t4.length && 0 === t4[0].length;
          }
          function E() {
            if (_2 && i3 && (R("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + a.DefaultDelimiter + "'"), i3 = false), e3.skipEmptyLines) for (var t4 = 0; t4 < _2.data.length; t4++) b2(_2.data[t4]) && _2.data.splice(t4--, 1);
            return w() && function() {
              if (_2) if (Array.isArray(_2.data[0])) {
                for (var t5 = 0; w() && t5 < _2.data.length; t5++) _2.data[t5].forEach(r4);
                _2.data.splice(0, 1);
              } else _2.data.forEach(r4);
              function r4(t6, r5) {
              ...
              function t5(t6, r5) {
                ...
                for (i4 = 0; i4 < t6.length; i4++) {
                  var s4 = i4, a2 = t6[i4];
                  e3.header && (s4 = i4 >= m2.length ? "__parsed_extra" : m2[i4]), e3.transform && (a2 = e3.transform(a2, s4)), a2 = C(s4, a2), "__parsed_extra" === s4 ? (n4[s4] = n4[s4] || [], n4[s4].push(a2)) : n4[s4] = a2;
                }
          ...
          function w() {
            return e3.header && 0 === m2.length;
          }
          function C(t4, r4) {
            return i4 = t4, e3.dynamicTypingFunction && void 0 === e3.dynamicTyping[i4] && (e3.dynamicTyping[i4] = e3.dynamicTypingFunction(i4)), true === (e3.dynamicTyping[i4] || e3.dynamicTyping) ? "true" === r4 || "TRUE" === r4 || "false" !== r4 && "FALSE" !== r4 && (function(e4) {
              if (o2.test(e4)) {
                var t5 = parseFloat(e4);
                if (s3 < t5 && t5 < n3) return true;
              }
              return false;
          ...
          function R(e4, t4, r4, i4) {
            ...
            void 0 !== i4 && (n4.row = i4), _2.errors.push(n4);
          }
          this.parse = function(n4, s4, o3) {
            ...
            if (e3.newline || (e3.newline = function(e4, t4) {
            ...
            }(n4, u3)), i3 = false, e3.delimiter) k(e3.delimiter) && (e3.delimiter = e3.delimiter(n4), _2.meta.delimiter = e3.delimiter);
            else {
              var h3 = function(t4, r4, i4, n5, s5) {
                ...
                for (var l3 = 0; l3 < s5.length; l3++) {
                  ...
                  h4 = void 0;
                  for (var _3 = new g({ comments: n5, delimiter: d3, newline: r4, preview: 10 }).parse(t4), y3 = 0; y3 < _3.data.length; y3++) if (i4 && b2(_3.data[y3])) m3++;
                  else {
                    var v2 = _3.data[y3].length;
                    p2 += v2, void 0 !== h4 ? 0 < v2 && (c3 += Math.abs(v2 - h4), h4 = v2) : h4 = v2;
                  }
                  0 < _3.data.length && (p2 /= _3.data.length - m3), (void 0 === u4 || c3 <= u4) && (void 0 === f4 || f4 < p2) && 1.99 < p2 && (u4 = c3, o4 = d3, f4 = p2);
                }
        ...
        function g(e3) {
          var t3, r3 = (e3 = e3 || {}).delimiter, i3 = e3.newline, n3 = e3.comments, s3 = e3.step, o2 = e3.preview, u2 = e3.fastMode, h2 = t3 = void 0 === e3.quoteChar ? '"' : e3.quoteChar;
          if (void 0 !== e3.escapeChar && (h2 = e3.escapeChar), ("string" != typeof r3 || -1 < a.BAD_DELIMITERS.indexOf(r3)) && (r3 = ","), n3 === r3) throw new Error("Comment character same as delimiter");
          true === n3 ? n3 = "#" : ("string" != typeof n3 || -1 < a.BAD_DELIMITERS.indexOf(n3)) && (n3 = false), "\n" !== i3 && "\r" !== i3 && "\r\n" !== i3 && (i3 = "\n");
          var f2 = 0, l2 = false;
          this.parse = function(e4, a2, d2) {
            if ("string" != typeof e4) throw new Error("Input must be a string");
            var c2 = e4.length, g2 = r3.length, m2 = i3.length, _2 = n3.length, y2 = k(s3), v2 = [], b2 = [], E = [], w = f2 = 0;
            if (!e4) return z();
            if (u2 || false !== u2 && -1 === e4.indexOf(t3)) {
              for (var C = e4.split(i3), R = 0; R < C.length; R++) {
                if (E = C[R], f2 += E.length, R !== C.length - 1) f2 += i3.length;
                else if (d2) return z();
                if (!n3 || E.substring(0, _2) !== n3) {
                  if (y2) {
                    if (v2 = [], L(E.split(r3)), q(), l2) return z();
                  } else L(E.split(r3));
                  if (o2 && o2 <= R) return v2 = v2.slice(0, o2), z(true);
                }
              }
              return z();
            }
            for (var O = e4.indexOf(r3, f2), x = e4.indexOf(i3, f2), S = new RegExp(p(h2) + p(t3), "g"), T = e4.indexOf(t3, f2); ; ) if (e4[f2] !== t3) if (n3 && 0 === E.length && e4.substring(f2, f2 + _2) === n3) {
              if (-1 === x) return z();
              ...
              if (-1 === x) break;
              if (E.push(e4.substring(f2, x)), M(x + m2), y2 && (q(), l2)) return z();
              if (o2 && v2.length >= o2) return z(true);
            }
            else for (T = f2, f2++; ; ) {
              if (-1 === (T = e4.indexOf(t3, T + 1))) return d2 || b2.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: v2.length, index: f2 }), j();
              if (T === c2 - 1) return j(e4.substring(f2, T).replace(S, t3));
              if (t3 !== h2 || e4[T + 1] !== h2) {
                if (t3 === h2 || 0 === T || e4[T - 1] !== h2) {
                  -1 !== O && O < T + 1 && (O = e4.indexOf(r3, T + 1)), -1 !== x && x < T + 1 && (x = e4.indexOf(i3, T + 1));
                  var D = F(-1 === x ? O : Math.min(O, x));
                  if (e4[T + 1 + D] === r3) {
                  ...
                  if (e4.substring(T + 1 + A, T + 1 + A + m2) === i3) {
                    if (E.push(e4.substring(f2, T).replace(S, t3)), M(T + 1 + A + m2), O = e4.indexOf(r3, f2), T = e4.indexOf(t3, f2), y2 && (q(), l2)) return z();
                    if (o2 && v2.length >= o2) return z(true);
                    break;
                  }
            ...
            function j(t4) {
              return d2 || (void 0 === t4 && (t4 = e4.substring(f2)), E.push(t4), f2 = c2, L(E), y2 && q()), z();
            }
            function M(t4) {
        ...
        function m(e3) {
          ...
          if (t3.error) r3.userError(t3.error, t3.file);
            ...
            if (k(r3.userStep)) {
              ...
              delete t3.results;
            } else k(r3.userChunk) && (r3.userChunk(t3.results, s3, t3.file), delete t3.results);
          }
        ...
        function v(e3) {
          ...
          for (var r3 in e3) t3[r3] = v(e3[r3]);
          return t3;
        }
        function b(e3, t3) {
          return function() {
        ...
        return i2 && (t2.onmessage = function(e3) {
          var r3 = e3.data;
          if (void 0 === a.WORKER_ID && r3 && (a.WORKER_ID = r3.workerId), "string" == typeof r3.input) t2.postMessage({ workerId: a.WORKER_ID, results: a.parse(r3.input, r3.config), finished: true });
...
export default require_react_csv_reader();
...
react-csv-reader/dist/react-csv-reader.js:
  (* @license
  Papa Parse
  v5.3.0
